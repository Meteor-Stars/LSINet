    ...
    def vali(self, vali_data, vali_loader, criterion):
        ...
        with torch.no_grad():
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(vali_loader):
                ...
                preds.append(pred)
                trues.append(true)
        connection_matrix_sparse_rate={str(key): np.mean(value) for key, value in connection_matrix_sparse_rate.items()}
        print('Connection Matrix Sparse Rate',connection_matrix_sparse_rate['sparse_rate'])
        ...
        loss_dict['sparse_rate']=connection_matrix_sparse_rate
        self.model.train()
        return loss_dict
        ...
        for epoch in range(self.args.train_epochs):
            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(train_loader):
                ...
                if self.args.model=='Pathformer':
                    ...
                    if self.args.SpIntervel==1:
                        loss += loss_inf_all['loss_sparse']
                    elif epoch != 0 and epoch % self.args.SpIntervel == 0:
                        loss+=loss_inf_all['loss_sparse']
                    else:
                        pass
